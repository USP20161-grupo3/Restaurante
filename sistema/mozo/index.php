...
<div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<!-- <li>
                   <a href="#" onclick="load_div('contenido', 'local/local_pre_list.php');" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-home" aria-hidden="true">&nbsp;REG.LOCAL</span></a>
                </li>  -->
				
					
			
				<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-list-alt" aria-hidden="true">&nbsp;REG.PEDIDOS</span></a>
                </li>
