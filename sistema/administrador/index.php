            ...
            <ul class="sidebar-nav">
			 ...
			 <li>
				<a href="#" onclick="load_div('contenido', 'persona/persona_pre_list.php');" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-user" aria-hidden="true">&nbsp;REG.PERSONA</SPAN></a>        
                  ...
                  <li>
				<a href="#" onclick="load_div('contenido', 'usuario/usuario_pre_list.php');" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-user" aria-hidden="true">&nbsp;REG.TRABAJADOR</SPAN></a>        
                 </li> 
                 
                 		<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-plus" aria-hidden="true">&nbsp;REG.CAJA</span></a>
                </li>
				
				
				<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-plus" aria-hidden="true">&nbsp;REG.MESA</span></a>
                </li>
				
				<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-pushpin" aria-hidden="true">&nbsp;REG.PLATOS</span></a>
                </li>
                
                	<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-pushpin" aria-hidden="true">&nbsp;REG.MENU DEL DIA</span></a>
                </li>
				
			
				<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-list-alt" aria-hidden="true">&nbsp;REG.CARTA</span></a>
                </li>
                	<li>
                    <a href="#" onclick="" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-list-alt" aria-hidden="true">&nbsp;REPORTES</span></a>
                </li>
